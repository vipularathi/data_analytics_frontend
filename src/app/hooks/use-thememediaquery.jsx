...
/**
 * The useThemeMediaQuery function is a custom hook that returns a boolean
 * indicating whether the current screen matches
 * the specified media query.
 * It takes in a themeCallbackFunc as a parameter, which is a function that returns a string
 * representing the media query to match.
...
function useThemeMediaQuery(themeCallbackFunc) {
   ...
   * It takes in a media query string as a parameter and returns a boolean
   * indicating whether the screen matches the query.
   *
   */
