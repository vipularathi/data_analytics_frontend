...
function FuseNavVerticalTab(props) {
  const { item, onItemClick, firstLevel, dense, selectedId, checkPermission } =
    props;
            ...
            <Tooltip title={item.title || ""} placement="right">
              <div className="relative flex h-32 min-h-32 w-32 items-center justify-center">
                {item?.icon ? (
                  ...
                  item.title && (
                    <div className="text-16 font-bold">{item.title[0]}</div>
                  )
                )}
                {item.badge && (
                  <FuseNavBadge
            ...
            <>
              <div className="relative mb-8 flex h-32 min-h-32 w-32 items-center justify-center">
                {item?.icon ? (
                  ...
                  item.title && (
                    <div className="text-20 font-bold">{item.title[0]}</div>
                  )
                )}
                {item.badge && (
                  <FuseNavBadge
